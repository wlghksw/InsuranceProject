...
public class CalculatorService {
    ...
    // 각 보험별 요율표를 DB에서 조회하기 위한 Repository들을 주입받는다고 가정합니다.
    // 예: private final HealthGenderRateRepository healthGenderRateRepository;
     ...
     */
    public long calculate(CalRequestDTO requestDto) { // 메소드 이름 수정: calculator -> calculate
