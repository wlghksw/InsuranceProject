...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationSuccessHandler customLoginSuccessHandler) throws Exception {
        http
                ...
                .headers(headers -> headers.frameOptions(frameOptions -> frameOptions.sameOrigin())) // H2 콘솔용
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/", "/main", "/user/**", "/calculator", "/api/calculate", "/css/**", "/js/**", "/images/**", "/service_intro", "/h2-console/**").permitAll()
