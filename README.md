...
사용자의 나이, 성별, 건강 상태, 직업 등 프로필 정보를 기반으로 최적의 보험 상품을 추천하는 플랫폼
마이크로서비스 아키텍처로 설계되어 3개의 독립적인 서버가 협업
...
사용자가 직접 설정한 조건에 따라 보험 상품을 필터링하고 추천
...
사용자의 개인 정보를 분석하여 최적의 상품을 자동으로 추천
...
사용자가 원하는 조건과 가장 유사한 보험 상품을 찾아 추천
